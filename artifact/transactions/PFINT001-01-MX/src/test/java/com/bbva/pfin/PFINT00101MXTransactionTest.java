...
/**
 * Test for transaction PFINT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/PFINT00101MXTest.xml" })
public class PFINT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(PFINT00101MXTransactionTest.class);

	@Autowired
	private PFINT00101MXTransaction transaction;
